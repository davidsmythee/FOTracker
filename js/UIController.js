...
class UIController {
    ...
    teamNameToFileName(teamName) {
        ...
        const teamFileMap = {
            'Bellarmine University': 'bellarmine_university.json',
            'Boston University': 'boston_university.json',
            'Brown University': 'brown_university.json',
            'Bryant University': 'bryant_university.json',
            'Bucknell University': 'bucknell_university.json',
            'Canisius College': 'canisius_college.json',
            'Cleveland State University': 'cleveland_state_university.json',
            'Colgate University': 'colgate_university.json',
            'College of the Holy Cross': 'college_of_the_holy_cross.json',
            'Cornell University': 'cornell_university.json',
            'Dartmouth College': 'dartmouth_college.json',
            'Drexel University': 'drexel_university.json',
            'Duke University': 'duke_university.json',
            'Fairfield University': 'fairfield_university.json',
            'Georgetown University': 'georgetown_university.json',
            'Hampton University': 'hampton_university.json',
            'Harvard University': 'harvard_university.json',
            'High Point University': 'high_point_university.json',
            'Hobart & William Smith College': 'hobart_william_smith_college.json',
            'Hofstra University': 'hofstra_university.json',
            'Iona University': 'iona_university.json',
            'Jacksonville University': 'jacksonville_university.json',
            'Johns Hopkins University': 'johns_hopkins_university.json',
            'Lafayette College': 'lafayette_college.json',
            'Lehigh University': 'lehigh_university.json',
            'Long Island University': 'long_island_university.json',
            'Loyola University Maryland': 'loyola_university_maryland.json',
            'Manhattan College': 'manhattan_college.json',
            'Marist College': 'marist_college.json',
            'Marquette University': 'marquette_university.json',
            'Mercer University': 'mercer_university.json',
            'Merrimack College': 'merrimack_college.json',
            'Monmouth University': 'monmouth_university.json',
            "Mount St. Mary's University": 'mount_st_mary_s_university.json',
            'New Jersey Institute of Technology': 'new_jersey_institute_of_technology.json',
            'Ohio State University': 'ohio_state_university.json',
            'Penn State': 'penn_state.json',
            'Penn State University': 'penn_state.json',
            'Princeton University': 'princeton_university.json',
            'Providence College': 'providence_college.json',
            'Queens University of Charlotte': 'queens_university_of_charlotte.json',
            'Quinnipiac University': 'quinnipiac_university.json',
            'Robert Morris University': 'robert_morris_university.json',
            'Rutgers University': 'rutgers_university.json',
            'Sacred Heart University': 'sacred_heart_university.json',
            "Saint Joseph's University": 'saint_joseph_s_university.json',
            'Siena College': 'siena_college.json',
            'St. Bonaventure University': 'st_bonaventure_university.json',
            "St. John's University": 'st_john_s_university.json',
            'SUNY Binghamton University': 'suny_binghamton_university.json',
            'SUNY Stony Brook University': 'suny_stony_brook_university.json',
            'SUNY University at Albany': 'suny_university_at_albany.json',
            'Syracuse University': 'syracuse_university.json',
            'Towson University': 'towson_university.json',
            'United States Air Force Academy': 'united_states_air_force_academy.json',
            'United States Military Academy': 'united_states_military_academy.json',
            'United States Naval Academy': 'united_states_naval_academy.json',
            'University of Delaware': 'university_of_delaware.json',
            'University of Denver': 'university_of_denver.json',
            'University of Detroit Mercy': 'university_of_detroit_mercy.json',
            'University of Maryland': 'university_of_maryland.json',
            'University of Maryland – Baltimore County': 'university_of_maryland_baltimore_county.json',
            'University of Massachusetts – Amherst': 'university_of_massachusetts_amherst.json',
            'University of Massachusetts – Lowell': 'university_of_massachusetts_lowell.json',
            'University of Michigan': 'university_of_michigan.json',
            'University of North Carolina at Chapel Hill': 'university_of_north_carolina.json',
            'University of Notre Dame': 'university_of_notre_dame.json',
            'University of Pennsylvania': 'university_of_pennsylvania.json',
            'University of Richmond': 'university_of_richmond.json',
            'University of Utah': 'university_of_utah.json',
            'University of Vermont': 'university_of_vermont.json',
            'University of Virginia': 'university_of_virginia.json',
            'Villanova University': 'villanova_university.json',
            'Virginia Military Institute': 'virginia_military_institute.json',
            'Wagner College': 'wagner_college.json',
            'Yale University': 'yale_university.json'
        };
